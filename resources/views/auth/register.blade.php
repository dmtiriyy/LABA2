...
@section('content')
    <form method="POST" action="{{url('register')}}" class="form">
        ...
        <fieldset>
            ...
            <div class="form_item">
                <label for="name" class="form_item_label">Ім'я</label>
                @if ($errors->has('name'))
            ...
            <div class="form_item">
                <label for="email" class="form_item_label">E-Mail </label>
                @if ($errors->has('email'))
            ...
            <div class="form_item">
                <label for="password" class="form_item_label">Пароль</label>
            ...
            <div class="form_item">
                <label for="password-confirm" class="form_item_label">Підтвердіть пароль</label>
